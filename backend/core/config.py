...
# Existing embedding model — KEEP this for the existing ATS pipeline
SENTENCE_TRANSFORMER_MODEL = os.getenv(
    "SENTENCE_TRANSFORMER_MODEL",
    "all-MiniLM-L6-v2"
)

# Fine-tuned model (stored on Huggingface) — used specifically for Resume ↔ Job Description
# semantic matching.
FINETUNED_MODEL_ID = os.getenv(
    "FINETUNED_MODEL_ID",
    "umakant-ai/ats-scorer-finetuned-bert"
)
